...
def main():
    api_key = "pat_HaBYRppWtFugyPesI7rshnEEEx45g8fULhlXzmTRIf5PkWybRsJHadg5121CiLOV"
    bot_id = "7375638837089402886"
    user_id = "7374939786953703430"
    bot = CozeBot(api_key, bot_id)
